...
\newcommand{\myexperience}{
    ...
    \begin{tabular}{p{\dimexpr\textwidth-5em}r}
        {\bfseries Besiktas Municipality} --- Computer Engineer & 2024
    \end{tabular}

    \section{Internship Experience}
    \begin{tabular}{p{\dimexpr\textwidth-5em}r}
        {\bfseries Besiktas Municipality} & 2016
    \end{tabular}
}
...
\newcommand{\mydeneyim}{
    \section{İş Deneyimi}
    \begin{tabular}{p{\dimexpr\textwidth-5em}r}
        {\bfseries Beşiktaş Belediyesi} --- Bilgisayar Mühendisi & 2024
    \end{tabular}

    \section{Staj Deneyimi}
    \begin{tabular}{p{\dimexpr\textwidth-5em}r}
        {\bfseries Beşiktaş Belediyesi} & 2016
    \end{tabular}
}
...
\newcommand{\thmrank}{
    \links{\mythm}{TryHackMe Rank}: 2526 (44980 Pts)
}

\newcommand{\thmderece}{
    \links{\mythm}{TryHackMe Derecesi}: 2526 (44980 Puan)
}
