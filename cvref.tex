...
\def\mysertifikalar{
	...
	\begin{minipage}[t]{0.70\textwidth}
		BTKAkademi --- Sızma Testine Giriş\\
		BTKAkademi --- Siber Güvenlikte Linux İşletim Sistemleri\\
...
\def\mycertificates{
	...
	\begin{minipage}[t]{0.70\textwidth}
		BTKAkademi --- Introduction to Penetration Testing\\
		BTKAkademi --- Linux Operating Systems in the Cyber Security\\
		Udemy --- Broad Scope Bug Bounties From Scratch\\
		Udemy --- Practical Ethical Hacking - The Complete Course\\
		Udemy --- The Ultimate BAC and IDOR Guide for Ethical Hacking\\
		Udemy --- XSS Survival Guide\\
